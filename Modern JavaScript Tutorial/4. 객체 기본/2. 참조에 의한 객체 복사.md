...
반면, 원시값(문자열, 숫자, 불린 값)은 ‘값 그대로’ 저장·할당되고 복사된다.
...
<img src="https://ko.javascript.info/article/object-copy/variable-copy-value.svg" alt="" width="359" height="143">
...
<img src="https://ko.javascript.info/article/object-copy/variable-contains-reference.svg" alt="" width="370" height="249">
...
<img src="https://ko.javascript.info/article/object-copy/variable-copy-reference.svg" alt="" width="599" height="260">
...
방법은 있는데 자바스크립트는 객체 복제 내장 메서드를 지원하지 않기 때문에 조금 어렵다. 사실 객체를 복제해야 할 일은 거의 없다. 참조에 의한 복사로 해결 가능한 일이 대다수다.
